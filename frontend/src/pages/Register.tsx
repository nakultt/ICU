  ...
  return (
    <div className="app-grid-bg relative min-h-screen px-4 py-10 md:px-8 flex items-center justify-center">
      <div className="relative z-10 w-full max-w-lg">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="glass-card rounded-[2.5rem] p-8 md:p-12 shadow-2xl border border-white/10 relative overflow-hidden">
          
          <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-emerald-400 via-teal-500 to-cyan-500" />
          
          <div className="mb-8 text-center">
            <div className="mx-auto mb-5 inline-flex rounded-2xl bg-gradient-to-br from-teal-400/20 to-cyan-500/20 p-4 text-teal-400 ring-1 ring-white/10 shadow-[0_0_30px_rgba(20,184,166,0.15)]">
              <UserPlus size={28} />
            </div>
            <h1 className="text-3xl font-black text-slate-100 placeholder-slate-400">Create Account</h1>
          ...
          <form onSubmit={submitRegister} className="space-y-4">
            <input
              ...
              className="w-full rounded-2xl border border-slate-700/50 bg-slate-900/50 px-5 py-4 text-sm text-slate-100 outline-none transition focus:border-cyan-500 focus:bg-slate-900 focus:ring-4 focus:ring-cyan-500/10 placeholder-slate-500"
            />
            <input
              required
              type="email"
            ...
            <div className="flex gap-4 pt-2">
              ...
              <label className={`flex-1 flex cursor-pointer items-center justify-center gap-2 rounded-xl border ${role === 'nurse' ? 'border-emerald-500 bg-emerald-500/10 text-emerald-400' : 'border-slate-700 bg-slate-900/40 text-slate-400'} px-4 py-3 text-sm font-bold transition-all`}>
            ...
            <button
              ...
              className="mt-6 w-full rounded-2xl bg-gradient-to-r from-teal-500 to-cyan-600 px-5 py-4 text-sm font-black text-white shadow-xl shadow-cyan-900/40 transition-all hover:scale-[1.02] hover:shadow-cyan-900/60 active:scale-[0.98] disabled:opacity-70 flex justify-center items-center"
            >
              {state === 'loading' ? (
